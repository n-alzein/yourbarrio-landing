export default function HomePage() {
  return (
    <main className="relative min-h-screen text-white">
      ...
      {/* HERO */}
      <section className="max-w-7xl mx-auto px-6 pt-28 pb-16 md:pt-36 md:pb-24">
            ...
            <div className="mt-7 flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl px-6 py-3 font-semibold
                           ...
                           shadow-lg shadow-purple-500/30 hover:brightness-110 active:scale-[0.98] transition"
              >
                Get Started
              </a>
