...
const PURCHASE_HISTORY_SELECT =
  "id,order_number,created_at,paid_at,status,total, vendor:users!orders_vendor_id_fkey (business_name, full_name), order_items(id,image_url, listing:listings!order_items_listing_id_fkey(photo_url,photo_variants))";
