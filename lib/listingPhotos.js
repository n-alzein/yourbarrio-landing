...
function getVariantUrl(variant, useCase) {
  ...
  if (useCase === "listing_thumb") {
    return variant.variants.thumb_320 || variant.variants.card_640 || variant.variants.detail_1200 || null;
  }
  if (useCase === "listing_card") {
    return variant.variants.card_640 || variant.variants.thumb_320 || variant.variants.detail_1200 || null;
  }
  if (useCase === "listing_detail") {
    return variant.variants.detail_1200 || variant.variants.card_640 || variant.variants.thumb_320 || null;
  }
  return null;
}
