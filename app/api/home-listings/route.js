...
const LISTING_SELECT =
  "id,public_id,title,price,category,category_id,city,photo_url,photo_variants,business_id,created_at,inventory_status,inventory_quantity,low_stock_threshold,inventory_last_updated_at";
