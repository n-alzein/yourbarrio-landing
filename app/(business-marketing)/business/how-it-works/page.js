  ...
  return (
    <div className="min-h-screen text-white relative px-6 pb-24 pt-10">
      ...
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-3xl md:text-5xl font-bold tracking-tight">How it works</h1>
        <p className="mt-6 text-lg text-white/80">
          A simple flow: create your business profile, showcase your listings, and connect with nearby customers.
        </p>
      </div>
    </div>
  );
