...
export default async function BusinessProfileRoute() {
  ...
  const profile = (rawProfile && Object.keys(rawProfile).length ? {
    ...
    default_delivery_fee_cents:
      rawProfile.default_delivery_fee_cents ?? null,
    delivery_radius_miles: rawProfile.delivery_radius_miles ?? null,
    delivery_min_order_cents: rawProfile.delivery_min_order_cents ?? null,
    delivery_notes: rawProfile.delivery_notes ?? null,
    ...
    avatar_media_asset_id: rawProfile.avatar_media_asset_id ?? null,
    business_avatar_media_asset: rawProfile.business_avatar_media_asset ?? null,
