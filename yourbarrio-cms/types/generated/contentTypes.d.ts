...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    placement: Schema.Attribute.Enumeration<
      ['HOME_TOP', 'HOME_MIDDLE', 'CATEGORY_TOP']
    >;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Customer browsing categories.';
  ...
  attributes: {
    ...
    tileImage: Schema.Attribute.Media<'images'>;
    tileSubtitle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTileTile extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tile.tile'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<['HOME_FEATURED', 'HOME_CATEGORIES']>;
