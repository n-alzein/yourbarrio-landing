...
export default function HeroBanner({
  ...
  const heroHeightClassName = offsetContentForFixedNav
    ? "h-[calc(var(--yb-nav-h,80px)+clamp(280px,36vh,340px))] md:h-[calc(var(--yb-nav-h,80px)+clamp(300px,28vh,320px))]"
    : "min-h-[220px] sm:min-h-[244px] md:min-h-[38vh] lg:min-h-[40vh] xl:min-h-[43vh]";
  const contentShellClassName = offsetContentForFixedNav
    ? "relative z-10 flex h-full items-center justify-center pt-[var(--yb-nav-h,80px)]"
