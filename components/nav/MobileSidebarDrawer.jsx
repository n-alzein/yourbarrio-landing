...
export default function MobileSidebarDrawer({
  ...
  return createPortal(
    ...
    >
      ...
      />
      <div
        className={`absolute inset-y-0 left-0 w-[80vw] max-w-[360px] transform transition-transform duration-300 ease-out ${
        ...
        >
          <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
            ...
            <button
              ...
              type="button"
              onClick={onClose}
              className="rounded-full border border-white/15 bg-white/5 p-2 text-white/80 transition hover:text-white"
