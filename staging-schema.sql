...
CREATE POLICY "Business owners can delete own listings" ON "public"."listings" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "business_id"));



CREATE POLICY "Businesses can insert listings" ON "public"."listings" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "business_id"));



CREATE POLICY "Businesses can update own listings" ON "public"."listings" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "business_id"));
...
CREATE POLICY "User can insert saved listings" ON "public"."saved_listings" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "User can view saved listings" ON "public"."saved_listings" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "allow reading listings" ON "public"."listings" FOR SELECT USING (true);



CREATE POLICY "allow user to read own saved listings" ON "public"."saved_listings" FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Allow authenticated updates (business photos)" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'business-photos'::"text")) WITH CHECK (("bucket_id" = 'business-photos'::"text"));



CREATE POLICY "Allow authenticated uploads (business photos)" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'business-photos'::"text"));



CREATE POLICY "Allow authenticated uploads (listing photos)" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'listing-photos'::"text"));



CREATE POLICY "Allow public read (listing photos)" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'listing-photos'::"text"));



CREATE POLICY "Allow public read access (business photos)" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'business-photos'::"text"));



CREATE POLICY "Owner can delete avatar" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'avatars'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "Owner update avatar" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'avatars'::"text") AND ("owner" = "auth"."uid"()))) WITH CHECK ((("bucket_id" = 'avatars'::"text") AND ("owner" = "auth"."uid"())));



CREATE POLICY "Owner upload avatar" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'avatars'::"text") AND ("owner" = "auth"."uid"())));
